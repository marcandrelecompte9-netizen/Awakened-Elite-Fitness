...
const CACHE_NAME = 'awakened-v1128';
const ASSETS = [
  './',
  './index.html',
  './css/style.css',
  ...
  './images/kiosk_bg.webp',
  './images/tree_bg.webp',
  './images/calendar_empty.webp',
  ...
  './js/challenges.js',
  './js/family-boss.js',
  './js/family-network.js',
  './js/family-challenge.js',
  './js/family-goal.js',
  './js/family-feed.js',
  './js/pre-workout-mood.js',
  './js/workout-games.js',
  './js/kids-games.js',
  './js/group-workout.js',
  './js/youth-safety.js',
  './js/kids-programs.js',
  './js/senior-programs.js',
  './js/adaptive.js',
  './js/pain-mode.js',
  './js/recovery-mode.js',
  './data/items.js',
  './manifest.json?v=1128',
  './icons/icon-192.png?v=1128',
  './icons/icon-512.png?v=1128',
  './icons/icon-192-maskable.png?v=1128',
  './icons/icon-512-maskable.png?v=1128',
