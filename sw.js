...
const CACHE_NAME = 'awakened-v1060';
const ASSETS = [
  './',
  './index.html',
  './css/style.css',
  ...
  './js/recovery-mode.js',
  './data/items.js',
  './manifest.json?v=1060',
  './icons/icon-192.png?v=1060',
  './icons/icon-512.png?v=1060',
  './icons/icon-192-maskable.png?v=1060',
  './icons/icon-512-maskable.png?v=1060',
