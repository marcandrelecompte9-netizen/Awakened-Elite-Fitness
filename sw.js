...
const CACHE_NAME = 'awakened-v1048';
const ASSETS = [
  './',
  './index.html',
  './css/style.css',
  ...
  './js/recovery-mode.js',
  './data/items.js',
  './manifest.json?v=1048',
  './icons/icon-192.png?v=1048',
  './icons/icon-512.png?v=1048',
  './icons/icon-192-maskable.png?v=1048',
  './icons/icon-512-maskable.png?v=1048',
