...
const CACHE_NAME = 'awakened-v1080';
const ASSETS = [
  './',
  './index.html',
  './css/style.css',
  ...
  './js/recovery-mode.js',
  './data/items.js',
  './manifest.json?v=1080',
  './icons/icon-192.png?v=1080',
  './icons/icon-512.png?v=1080',
  './icons/icon-192-maskable.png?v=1080',
  './icons/icon-512-maskable.png?v=1080',
