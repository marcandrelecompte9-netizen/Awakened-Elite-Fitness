...
const CACHE_NAME = 'awakened-v932';
const ASSETS = [
  './',
  './index.html',
  './css/style.css',
  ...
  './data/items.js',
  './manifest.json?v=932',
  './icons/icon-192.png?v=932',
  './icons/icon-512.png?v=932',
  './icons/icon-192-maskable.png?v=932',
  './icons/icon-512-maskable.png?v=932',
