...
(function (global) {
  ...
  var PILATES_EXERCISES = [
    ...
    _dx('pilates', "Chat-Vache (Cat-Cow)", "Dos", "Mobilité de la colonne à quatre pattes, synchronisée au souffle.", ["À quatre pattes, mains sous les épaules", "Inspire : creuse légèrement le dos, regard devant", "Expire : arrondis le dos, menton vers la poitrine", "Enchaîne lentement et fluide"], "Le mouvement part du bassin, pas de la nuque.", 45),
    _dx('pilates', "Coléoptère (Dead Bug)", "Abdominaux", "Bras et jambe opposés qui s'éloignent, bas du dos plaqué au sol.", ["Allongée, bras vers le plafond, jambes en table", "Descends bras droit + jambe gauche à l'opposé", "Reviens au centre, puis alterne", "Le bas du dos reste collé au sol"], "Si le dos se creuse, réduis l'amplitude.", 45),
    _dx('pilates', "Sirène (Mermaid)", "Obliques", "Étirement latéral assis, une main au sol, l'autre par-dessus la tête.", ["Assise sur le côté, jambes repliées", "Une main au sol, l'autre monte et s'incline au-dessus de la tête", "Étire tout le flanc, souffle", "Reviens et change de côté"], "Grandis la colonne avant de t'incliner.", 40)
  ];
  var PILATES_INTERMEDIAIRE = [
    _dx('pilates', "Double Leg Stretch", "Abdominaux", "Bras et jambes s'étendent puis se regroupent, abdos engagés.", ["Épaules décollées, genoux serrés vers la poitrine", "Étends bras et jambes en diagonale", "Décris un cercle avec les bras et regroupe", "Le bas du dos reste plaqué"], "Plus les jambes sont basses, plus c'est intense.", 40, "Intermédiaire"),
    _dx('pilates', "Criss-Cross", "Obliques", "Coude vers le genou opposé en alternance, comme un pédalage lent.", ["Mains derrière la tête, épaules décollées", "Amène le coude vers le genou opposé", "Tends l'autre jambe, tourne le buste", "Alterne lentement, expire à chaque rotation"], "La rotation vient des côtes, pas des coudes.", 40, "Intermédiaire"),
    _dx('pilates', "Roulé en boule (Rolling Like a Ball)", "Abdominaux", "En équilibre sur le sacrum, roule en arrière puis reviens sans poser les pieds.", ["Assise en boule, mains sur les tibias", "Bascule en arrière jusqu'aux omoplates", "Reviens en équilibre sans poser les pieds", "Contrôle avec le centre"], "Garde la boule bien ronde, menton rentré.", 40, "Intermédiaire"),
    _dx('pilates', "Rotation assise (Spine Twist)", "Obliques", "Assise bien droite, rotations contrôlées du buste de chaque côté.", ["Assise, jambes tendues, bras en croix", "Grandis-toi puis tourne le buste d'un côté", "Deux petites impulsions, reviens au centre", "Change de côté, bassin fixe"], "Ce sont les côtes qui tournent, pas les hanches.", 40, "Intermédiaire"),
    _dx('pilates', "Ciseaux (Scissors)", "Abdominaux", "Jambes tendues vers le plafond qui alternent en ciseaux, mains au mollet.", ["Épaules décollées, jambes vers le plafond", "Attrape une cheville, l'autre jambe descend", "Change en ciseaux, deux impulsions par jambe", "Le tronc reste stable"], "Descends la jambe libre seulement si le dos reste plaqué.", 40, "Intermédiaire"),
    _dx('pilates', "Pont sur une jambe", "Fessiers", "Pont fessier avec une jambe tendue, bassin bien horizontal.", ["En pont, monte le bassin", "Tends une jambe dans l'axe de la cuisse", "Maintiens le bassin horizontal", "Change de jambe à mi-temps"], "Ne laisse pas la hanche s'affaisser du côté libre.", 40, "Intermédiaire"),
    _dx('pilates', "Le Cygne (Swan)", "Lombaires", "Extension du dos à plat ventre, poitrine décollée en contrôle.", ["À plat ventre, mains sous les épaules", "Décolle la poitrine en allongeant la colonne", "Ouvre le cœur, fessiers engagés", "Redescends lentement"], "Grandis-toi vers l'avant plutôt que de forcer en arrière.", 40, "Intermédiaire"),
    _dx('pilates', "Coup de pied latéral en série", "Fessiers", "Sur le côté, la jambe du dessus enchaîne battements et cercles contrôlés.", ["Allongée sur le côté, jambe du dessus à hauteur de hanche", "Balance avant/arrière avec contrôle", "Enchaîne de petits cercles", "Tronc gainé, bassin immobile"], "Le buste ne doit jamais bouger.", 45, "Intermédiaire")
  ];
  var PILATES_AVANCE = [
    _dx('pilates', "Teaser complet", "Abdominaux", "Le 'V' complet : buste et jambes tendues décollés en équilibre parfait.", ["Allongée, monte simultanément buste et jambes tendues", "Forme un 'V', bras parallèles aux jambes", "Tiens l'équilibre sur les ischions", "Redescends vertèbre par vertèbre"], "Enroule le bas du dos en premier à la descente.", 40, "Avancé"),
    _dx('pilates', "Neck Pull", "Abdominaux", "Roll-up avancé, mains derrière la tête, jambes tendues et fixes.", ["Allongée, mains derrière la tête, jambes tendues", "Enroule-toi jusqu'à l'avant, coudes ouverts", "Grandis-toi puis déroule lentement", "Chaque vertèbre se pose une à une"], "Ne tire pas sur la nuque, le mouvement vient des abdos.", 40, "Avancé"),
    _dx('pilates', "Jackknife (Canif)", "Abdominaux", "Jambes qui montent à la verticale puis le bassin décolle vers le plafond.", ["Allongée, jambes tendues à 90°", "Décolle le bassin, jambes vers le plafond", "Contrôle la descente vertèbre par vertèbre", "Jambes stables tout du long"], "Ce sont les abdos, pas l'élan, qui soulèvent le bassin.", 40, "Avancé"),
    _dx('pilates', "Tire-bouchon (Corkscrew)", "Abdominaux", "Jambes tendues qui dessinent un grand cercle, bassin décollé en contrôle.", ["Allongée, jambes tendues vers le plafond", "Décris un cercle des jambes d'un côté", "Décolle le bassin en haut du cercle", "Change de sens, tronc gainé"], "Garde les épaules ancrées au sol.", 40, "Avancé"),
    _dx('pilates', "Double coup de pied (Double Leg Kick)", "Lombaires", "À plat ventre, talons vers les fessiers puis extension du buste.", ["À plat ventre, mains dans le dos", "Fléchis les deux talons vers les fessiers (3 fois)", "Tends les bras et décolle le buste", "Alterne joue posée à chaque cycle"], "Enchaîne flexion et extension sans à-coups.", 40, "Avancé"),
    _dx('pilates', "Planche jambe levée (Leg Pull Front)", "Abdominaux", "Planche haute où une jambe se lève sans bouger le bassin.", ["En planche haute, corps gainé et aligné", "Lève une jambe tendue sans creuser le dos", "Repose, alterne", "Bassin parfaitement stable"], "Aucune bascule du bassin : c'est le gainage qui travaille.", 40, "Avancé"),
    _dx('pilates', "Grand contrôle (Control Balance)", "Abdominaux", "Jambes au-dessus de la tête, une jambe s'étire vers le plafond en équilibre.", ["Jambes tendues au-dessus de la tête, mains sur une cheville", "Tends l'autre jambe vers le plafond", "Alterne en contrôle, tronc stable", "Reste gainée tout du long"], "Version exigeante : garde le contrôle plutôt que l'amplitude.", 40, "Avancé"),
    _dx('pilates', "Boomerang", "Abdominaux", "Enchaînement fluide roulé-arrière, teaser et étirement en une séquence.", ["Assise, jambes croisées tendues devant", "Roule en arrière, jambes au-dessus de la tête", "Reviens en teaser, bras en arrière", "Enroule vers l'avant et étire"], "C'est un enchaînement : cherche la fluidité, pas la vitesse.", 45, "Avancé")
  ];
  var PILATES_SESSIONS = [
    { id: 'centre', name: 'Pilates Fondations', level: 'Débutant', rest: 10, exercises: PILATES_EXERCISES },
    { id: 'controle', name: 'Pilates Contrôle', level: 'Intermédiaire', rest: 8, minLevel: 3, exercises: PILATES_INTERMEDIAIRE },
    { id: 'maitrise', name: 'Pilates Maîtrise', level: 'Avancé', rest: 8, minLevel: 6, exercises: PILATES_AVANCE }
  ];
  ...
  var CALIS_PROGRESSIONS = [
    ...
    { skill: 'Muscle-up', emoji: '⚡', muscle: 'Dos', requires: { skill: 'Traction (pull-up)', steps: 5, label: 'Traction complète' }, steps: ['Tractions strictes solides', 'Tractions explosives (poitrine à la barre)', 'Travail de la transition (négatives)', 'Muscle-up complet'] },
    { skill: 'Planche', emoji: '🛩️', muscle: 'Épaules', requires: { skill: 'Dips', steps: 3, label: 'Dips complets' }, steps: ['Pseudo-planche push-up', 'Planche lean (penché)', 'Tuck planche', 'Advanced tuck planche', 'Straddle planche', 'Full planche'] },
    { skill: 'Front lever', emoji: '➖', muscle: 'Dos', requires: { skill: 'Traction (pull-up)', steps: 4, label: 'Tractions assistées' }, steps: ['Tractions & gainage solides', 'Tuck front lever', 'Advanced tuck', 'Une jambe tendue', 'Straddle', 'Full front lever'] },
    { skill: 'Drapeau humain', emoji: '🚩', muscle: 'Obliques', requires: { skill: 'L-sit', steps: 3, label: 'L-sit genoux groupés' }, steps: ['Renforcement obliques/épaules', 'Appui vertical (support hold)', 'Drapeau jambes groupées', 'Descente lente', 'Drapeau complet'] }
  ];
